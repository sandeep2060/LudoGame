-- Ludo King Database Schema - FIXED VERSION
...
DROP POLICY IF EXISTS "Users can remove own friendships" ON friends;

DROP POLICY IF EXISTS "Users can view relevant messages" ON chat_messages;
DROP POLICY IF EXISTS "Users can send messages" ON chat_messages;

DROP POLICY IF EXISTS "Users can view own bets" ON game_bets;
DROP POLICY IF EXISTS "Users can create own bets" ON game_bets;
